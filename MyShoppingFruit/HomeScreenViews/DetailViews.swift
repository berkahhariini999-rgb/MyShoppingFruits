    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 25){
           Image("bg")
            ...
            Text ("Each (500g - 700g)")
                .padding(.horizontal)
            Text("Organic agriculture is intended to produce high-quality, safe, and nutritious food. It is a sustainable way to produce food that is good for people, the environment, and the economy.")
                .font(.body)
                .fontWeight(.regular)
